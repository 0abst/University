...
Data = pd.read_csv('C:\Users\Documents\HSG\Semestre 2\Dynamic programming\Optimal-Rebalancing-Strategy-using-Dynamic-Programming-master\Optimal-Rebalancing-Strategy-using-Dynamic-Programming-master\Data.csv')
